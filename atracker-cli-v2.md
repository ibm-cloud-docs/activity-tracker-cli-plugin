...
## ibmcloud atracker target create {{site.data.keyword.atracker_full_notm}} hosted event search)
...
## ibmcloud atracker target update ({{site.data.keyword.atracker_full_notm}} hosted event search)
